...
public class SpectrumGainSettingScreen extends HeaderedAbstractSpectrumSettingScreen {
    protected SpectrumGainSettingScreen() {
        super(Component.literal("Change Spectrum Gain"));
    }
    ...
    protected void init() {
        ...
        addRenderableWidget(slider=new ForgeSlider(
                ...
                Component.empty(),
                0.,10., RipplesConfig.SPECTRUM_GAIN.get(),
                0.02,2,true
        ));
    }
